...
public class Command_adventure extends C_Command implements CommandExecutor {
    
    private final FreedomHostingMod plugin;

    public Command_adventure(FreedomHostingMod plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String string, String[] args) {
        ...
        Bukkit.broadcastMessage(ChatColor.AQUA + sender.getName() + "has changed his gamemode to adventure mode.");
